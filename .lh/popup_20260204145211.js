document.addEventListener('DOMContentLoaded', () => {
  ...
  const elements = {
    ...
    bugsBtn: document.getElementById('bugsBtn'),donateBtn = document.getElementById("donateBtn");
const donateDropdown = document.getElementById("donateDropdown");
  ...
  function setupEventListeners() {
    ...
    elements.donateBtn.addEventListener('click', () => chrome.tabs.create({ url: 'https://github.com/damirqa-work/damproxytabs/' }));
