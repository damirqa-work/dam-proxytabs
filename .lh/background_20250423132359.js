...
function handleWebRequest(details) {
  ...
  if (!extensionState.activeTab.url || !extensionState.activeTab.url==="" ) return;
  if (!details.url || !details.url.startsWith('http')   if (requestUrl.protocol === 'chrome-extension:') return;) return;
